  ...
  return (
    <section>
      <div>
        ...
        <p className=' text-lg py-5 leading-8 md:text-xl mb-10'>
      ...
      <div className={gradientNeon1}>
        ...
        <div className=' text-center  p-10 ' >
          <Image className=' mx-auto'src={design} width={100} height={100}></Image>
            <h3 className=' text-3xl lg:text-4xl md:text-4xl  py-1 font-titillumWebBold text-neon-text-water mt-10'>2010: BBA degree University</h3>
        ...
        <div className=' text-center p-10  '>
          <Image className=' mx-auto'src={design} width={100} height={100}></Image>
            <h3 className=' text-3xl lg:text-4xl md:text-4xl  py-1 font-titillumWebBold text-neon-text-water mt-10'>2016: Leading teams</h3>
        ...
        <div className=' text-center  p-10 '>
          <Image className=' mx-auto'src={design} width={100} height={100}></Image>
            <h3 className=' text-3xl lg:text-4xl md:text-4xl  py-1 font-titillumWebBold text-neon-text-water mt-10'>2020: The turning point</h3>
