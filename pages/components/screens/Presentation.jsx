    ...
    <section id='presentation'>
        ...
        <div className='w-full justify-center items-center'>
            ...
            <div className={`lg:flex justify-center items-center  ${bgLightMode} max-w-5xl mx-auto`}>
                <div className=' flex justify-center items-center '><Image src={profilePictureXpT2} width={250} ></Image></div>
            ...
            <div className=' flex justify-center items-center py-5 '>
                ...
                <div>
                    ...
                    <p className='mx-0  py-5 px-0 text-center font-extralight max-w-md'>{productManagerDesc}</p>
                    </div>
                </div>  
